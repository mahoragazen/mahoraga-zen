...
const PRODUCTS = [
  {
    ...
    summary: "หนังสือเล่มหลักของมโหราคะเซน — ๑๒ บท ๒๔๐ หน้า ที่จะเปลี่ยนวิธีคิดของคุณ ต่อความสำเร็จและความสุข",
    ornament: "lotus",
    aspect: "3/4",
  },
  {
    ...
    summary: "บทสวดโบราณ ๓๖ บท ที่บันทึกในวัดเก่าแก่ ความยาว ๓.๒ ชั่วโมง — ฟังเพื่อปรับคลื่น ก่อนการประชุมสำคัญ",
    ornament: "om",
    aspect: "1/1",
  },
  {
    ...
    summary: "สมาธินำทางที่ออกแบบมาสำหรับผู้นำ — ๓๐ นาที ที่จะคืนพลังให้กับวันที่เหนื่อยล้าที่สุด",
    ornament: "mandala",
    aspect: "1/1",
  },
  {
    ...
    summary: "ภาพพื้นหลังลายมันดาลาทอง ๓๐ ลาย ทั้ง ๔K สำหรับ Desktop และขนาดมือถือ — สร้างพื้นที่ศักดิ์สิทธิ์ในที่ทำงาน",
    ornament: "seed",
    aspect: "3/4",
  },
];
